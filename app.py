...
if st.session_state.page == "mattone1":
    ...
    for _col,_lbl,_pg,_ok in [
        (_c1,"🌍 Macro",    "mattone1",True),
        (_c2,"📊 Settori",  "mattone2",_rdy),
        (_c3,"🔍 Screening","mattone3",_rdy),
        (_c4,"🎯 FairValue","mattone4",_rdy),
    ]:
        with _col:
            if st.button(_lbl, key="nav_"+_pg+"_"+st.session_state.page,
    ...
    st.markdown("<hr style='border:none;border-top:1px solid #f0f0f0;margin:10px 0 18px'>", unsafe_allow_html=True)
